...
export const metadata: Metadata = {
  title: "Wix to Shopify Migration Service | ShopifyTasker",
  description:
    "Wix to Shopify migration. Products, content, SEO & 301 redirects transferred. Move your Wix site to Shopify. Pay after delivery.",
  alternates: {
