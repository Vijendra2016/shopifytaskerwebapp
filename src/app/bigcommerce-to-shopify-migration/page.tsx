...
export const metadata: Metadata = {
  title: "BigCommerce to Shopify Migration | Expert Migration Service | ShopifyTasker",
  description:
    "Migrate from BigCommerce to Shopify or Shopify Plus. Transfer products, customers, orders, SEO, and integrations with zero data loss. Pay after delivery.",
  alternates: {
