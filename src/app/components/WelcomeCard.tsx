    ...
    <>
      ...
      >
        ...
        <button
          ...
          className=" cursor-pointer  animate-jump animate-infinite inline-flex items-center bg-green-300 text-black px-4 py-2 rounded-full text-sm font-medium hover:bg-blue-400  transition"
        >
          Get Started 
