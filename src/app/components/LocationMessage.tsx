...
const LocationMessage = () => {
  ...
  const LocationMessage = () => {
    switch (country) {
      case "US":
        return city
          ? `Looking Shopify developer & expert near ${city}, U.S.? Local Shopify developers typically charge $80 t0 $120/hour — our experts deliver the same quality from just $25/hour, and you pay only after delivery Trusted by leading Australian brands · 100+ projects delivered · Pay later with confidence`
      ...
      case "AU":
        return city
          ? `Looking Shopify developer & expert near ${city}, Australia? While local developers often charge $100+/hour, our experienced team offers the same premium quality for just $35 AUD/hour.`
