...
const WhySwitchSection: React.FC = () => {
  ...
  return (
    <section className="bg-teal-700 text-white py-16 pt-30 pb-30 px-6 md:px-20 relative overflow-hidden">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between">
        <div className="mb-10 md:mb-0 md:w-1/2">
          ...
          <h2 className="text-4xl md:text-6xl font-thik  leading-tight mb-6">
        ...
        <div className="bg-gray-100 text-gray-800 p-6 md:p-10 rounded-3xl shadow-lg md:w-1/2 relative z-10">
