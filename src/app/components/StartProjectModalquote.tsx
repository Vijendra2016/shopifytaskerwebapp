...
export default function StartProjectModal({ isOpen, onClose }: Props) {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-30 flex justify-end z-[999999]">



      
        
      <div className="w-full md:w-[500px] h-half bg-[#fefdf9] p-6 pt-30  overflow-y-auto relative">
        <button className="absolute  pt-20 text-black cursor-pointer top-1 right-2 text-lg" onClick={onClose}>
          ✕ close
        </button>
        ...
        <form onSubmit={handleSubmit}>
          ...
          {step === 1 && (
            <>
              <h2 className="text-xl text-black font-bold mb-2 text-left">Lets Start</h2>
