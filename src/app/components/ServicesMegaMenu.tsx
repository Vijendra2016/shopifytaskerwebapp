...
const categories = [
  {
    ...
    services: [
      ...
      },
      {
        ...
        image: BASE + "69ddd9ffe1a03a019ad76353_shopify-theme-customization-service.png",
      },
      {
        title: "Custom Shopify Theme Development",
        desc: "Convert Figma/Deign to custom shopify theme.",
        href: "/theme-customization-1",
        image: BASE + "69dde2fe1047263fa34c33aa_customshopifythemedevelopment.png",
      },
      {
        title: "Existing Theme Update Services & Tweaks",
        desc: "Update existing themes to latest version,  bespoke layouts and precise brand styling.",
        href: "/theme-customization",
