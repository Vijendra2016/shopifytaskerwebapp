      ...
      <div className="mt-12 space-y-12">
        {services.map((service) => (
          ...
          >
            ...
            <div   onClick={handleCardClick} className="  cursor-pointer mt-4 md:mt-0  text-4xl md:ml-8 flex items-center justify-center w-26 h-26 rounded-full border-2  border-white">
