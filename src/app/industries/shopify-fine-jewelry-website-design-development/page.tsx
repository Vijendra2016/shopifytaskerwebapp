...
export default function pricing() {
  return (
    <main className="container bg-[#fefdf9] mx-auto px-0 py-0 text-center pt-0">
      <BreadcrumbSchema items={[{ name: "Home", href: "/" }, { name: "Industries", href: "/industries" }, { name: "Shopify Fine Jewelry Website", href: "/industries/shopify-fine-jewelry-website-design-development" }]} />
