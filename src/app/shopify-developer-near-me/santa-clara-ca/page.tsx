...
export default function city() {
  return (
    <main className="container mx-auto px-4 py-10 text-center pt-20">
      <BreadcrumbSchema items={[{ name: "Home", href: "/" }, { name: "Shopify Developer Near Me", href: "/shopify-developer-near-me" }, { name: "Shopify Developer in Santa Clara, CA" }]} />
        ...
        <section className="flex flex-col-reverse lg:flex-row items-center justify-between px-6 py-12 lg:py-20 max-w-7xl mx-auto">
              ...
              <div className="lg:w-1/2 text-center lg:text-left space-y-6">
                ...
                Hire  Shopify Developer in Santa Clara, CA
                </h1>
