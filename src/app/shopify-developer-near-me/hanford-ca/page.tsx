...
export default function smallTask() {
  return (
    <main className="container bg-[#fefdf9] mx-auto px-0 py-0 text-center pt-0">
      <BreadcrumbSchema items={[{ name: "Home", href: "/" }, { name: "Shopify Developer Near Me", href: "/shopify-developer-near-me" }, { name: "Shopify Developer in Hanford, CA" }]} />
...
Shopify Website Design & Development in Hanford, CA <br></br> Expert Shopify Developers
