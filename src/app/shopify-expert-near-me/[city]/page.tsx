...
<h3 className="text-3xl font-bold mb-4">
        ...
        <p className="font-semibold text-blue-600"> ttest we have 10 years experience on shopify ecosystem , we work on real prices not much price like $150/hr our hourly prices is fixed $20 and we dont take any upfront payment .</p>
